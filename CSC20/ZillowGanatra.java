/*
Name: Aarsh Ganatra
Description: The purpose of this software is to manage Zillow properties.
date: 24/03/2024
...
class YourDriver
{
 public static void main (String args[])
 {
  ...
  //public void add(int rooms, int baths, double price, double area, String address, String zipcode, int index)
  app.add(3, 2, 650000.0, 4800.0, "246 J st", "72547");
  app.add(4, 3, 350000.0, 6200.0, "135 fair oaks", "65235");
  app.add(2, 1, 550000.0, 2200.0, "241 Q St", "73469");
  app.add(5, 4, 750000.0, 1800.0, "352 Jay St", "32648");
  app.add(3, 2, 500000.0, 5000.0, "215 Cedar St", "25747");
  while(true)
  {
   choice();
   if(kb.hasNextInt())
  ...
  System.out.println("Enter anything letteror any other digit to end the program.");
 }
}
