...
Testimony: I have not recived the code from any AI websites or any other websites. I have written the code myself. Name: Aarsh Ganatra
*/
import java.util.*;
public class LotteryGanatra
{
}
